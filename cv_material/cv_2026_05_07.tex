...
\usepackage{mathptmx} % Times-style serif body
...
% ===== Section heading: SMALL CAPS BOLD with rule below =====
\titleformat{\section}{\scshape\bfseries\large}{}{0pt}{}[\vspace{1pt}\titlerule]
\titlespacing{\section}{0pt}{10pt}{4pt}

% ===== Dated entry: date left (2.8cm), content right =====
...
Generative AI on Mobile Systems, Mobile Computing, Spatial Intelligence, On-Device LLMs / VLMs, Embodied AI.
...
\begin{itemize}[leftmargin=1.1em, itemsep=2pt, topsep=3pt]
  \item \textbf{(May 2025 -- Present)} Led research on on-device VLM spatial reasoning: photo-realistic 3D benchmark synthesis (CVPR'26 Oral), on-device cross-frame reasoning deployed on Jetson Orin / AR Glass / smartphone, and Dirichlet-energy latent shaping of VLMs.
  \item \textbf{(Nov 2024 -- May 2025)} Drove research on on-device LLM personalization (MobiSys'25 Xpert) and training-free fine-grained interpretability for diffusion / GAN / autoregressive image generators (FineXL).
  \item \textbf{(Sept 2022 -- Oct 2024)} Designed federated learning systems for heterogeneous AIoT fleets: gradient correction under intertwined data / device heterogeneity (MobiCom'25); federated learning with unbounded staleness via gradient inversion (AAAI'25).
\end{itemize}
\end{datedentry}

\begin{datedentry}{Sept 2024 -- Present}
\textbf{Teaching Assistant}\\
Department of Electrical and Computer Engineering, University of Pittsburgh
\begin{itemize}[leftmargin=1.1em, itemsep=1pt, topsep=2pt]
  \item ECE 1175 -- Embedded System Design (Fall 2024); ECE 1195 -- Advanced Digital Design (Spring 2025); ECE 1396 -- Introduction to Machine Learning (Fall 2025); ECE 2570 -- Robotic Control (Spring 2026).
\end{itemize}
\end{datedentry}

\begin{datedentry}{Sept 2020 -- Jun 2022}
\textbf{Undergraduate Research Assistant}\\
Department of Control Science and Technology, Zhejiang University, Hangzhou, China
\begin{itemize}[leftmargin=1.1em, itemsep=2pt, topsep=2pt]
  \item Designed signal processing techniques for near-ultrasonic acoustic sensing systems on commodity smartphones.
\end{itemize}
\end{datedentry}
...
\me, Wei Gao.\\
\textit{Proceedings of the 39th AAAI Conference on Artificial Intelligence}, 2025 (Acceptance 23.4\%). \href{https://arxiv.org/abs/2309.13536}{[arXiv]}\,\href{https://haomingwang645.github.io/pdfs/aaai25_paper.pdf}{[Paper]}
...
\impactbullet{\textbf{Architected FineXL}, a training-free method decomposing a personalized image generator's divergence from its base into orthogonal natural-language concepts with quantitative scores; cut single-aspect explanation error by 56\%.}
...
\textbf{Programming:} Python, PyTorch, CUDA, C/C++, MATLAB, LaTeX.\\[2pt]
\textbf{Models \& Tools:} Stable Diffusion, CLIP, Gemini, GPT-4o/5, InternVL, Qwen-VL, LLaVA-Video, Grounding-SAM, DepthPro.\\[2pt]
\textbf{Simulation \& Edge Platforms:} Habitat, Isaac Sim, Infinigen, Blender; Jetson Orin (PyTorch + TensorRT), Meta AR Glass, Android (ONNX / NNAPI), Unitree Go2, RealSense.
