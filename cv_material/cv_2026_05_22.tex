...
\begin{itemize}[leftmargin=1.1em, itemsep=2pt, topsep=2pt]
  ...
  \item \textbf{Recognized Academic Excellence:} First-author publications across top-tier computer vision, AI, and mobile systems venues (CVPR'26 Oral, AAAI'25, MobiSys'25, MobiCom'25).
\end{itemize}
